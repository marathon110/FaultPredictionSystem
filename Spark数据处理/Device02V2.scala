...
/**
  ...
  */
class Device02V2 extends Ordered[Device02V2] with Serializable {
  @BeanProperty
  ...
  @BeanProperty
  var virtualDisk_numberReadAveraged_average: String = null
  @BeanProperty
  var virtualDisk_numberWriteAveraged_average: String = null
  @BeanProperty
  ...
  override def toString=
    s"$device_id," +
      ...
      s"$virtualDisk_numberReadAveraged_average," + //f
      s"$virtualDisk_numberWriteAveraged_average," +
  ...
  override def compare(that: Device02V2): Int = {
    // 先比较日期，日期相等再比较时间
